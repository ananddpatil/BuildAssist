...
#-----------------------------------Inser records to tbl_sales_emp  --------	
	...
	{
		$_SESSION['msg']="ERR-PSSWD-01: Something is wrong. Either the activation code has been used before or your account might be blocked. Please try resetting password again using FORGOT PASSWORD link.";
...
$smarty->display("login/reset-password.tpl"); 
$dbObj->Close();
?>
