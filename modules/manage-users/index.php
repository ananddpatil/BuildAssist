...
#-----------------------------------Inser records to tbl_sales_emp  --------	
	...
	$message = "<html>
<head>
<title>Real Estate Sales System</title>
</head>
<body>
...
$mail->Subject = "Welcome to Sales System";
$mail->MsgHTML($message);

$address = $Emailid;
$mail->AddAddress($address, $fname." ".$lname);
//$mail->AddAddress("pinn.alerts@gmail.com", "Test Email");


if(!$mail->Send()) {
 $_SESSION['msg']="User had been added successfully. But, the password has not been sent to the email account. Please request the user to set his her password via Forgot Password link.";
 
} else {
  $_SESSION['msg']="User had been added successfully and notified via email."; 
}

//Include below for sending Emails - ENDS
	
		
		//Commented out by Anand on 9 Aug 2012
